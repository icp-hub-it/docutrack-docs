...
**Focus**: Start React migration with wireframing, tackle II upgrades (now with AgentJS v3), and integrate VetKD as core crypto foundation. This sets secure auth and key flows early.
